...
public class MatMulTest implements Serializable {
    ...
    public void runMatmul() {
        ...
        // final Tuple3<R1CSRelationRDD<Fp>, Assignment<Fp>, JavaPairRDD<Long, Fp>> constructionRDD = R1CSConstruction.matmulConstruct(n1, n2, n3, fieldFactory, config);
    ...
    public void runLR() {
        ...
        final Tuple3<R1CSRelationRDD<BN254aFr>, Assignment<BN254aFr>, JavaPairRDD<Long, BN254aFr>> LRProduct =
    ...
    public void runGaussian() {
        ...
        final Tuple3<R1CSRelationRDD<Fp>, Assignment<Fp>, JavaPairRDD<Long, Fp>> meanCov = R1CSConstruction.gaussianFitApp(fieldFactory,
                config,
                n, d, bn, bd);
