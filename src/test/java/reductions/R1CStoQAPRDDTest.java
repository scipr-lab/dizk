...
public class R1CStoQAPRDDTest implements Serializable {
  ...
  public void VerifyQAPRelationTest() {
    ...
    qapRDD
        ...
        .foreach(
            elem -> {
              System.out.println(
                  "A(" + elem._1 + "): " + qap.At(elem._1.intValue()) + " == " + elem._2);
    ...
    qapRDD
        ...
        .foreach(
            elem -> {
              System.out.println(
                  "B(" + elem._1 + "): " + qap.Bt(elem._1.intValue()) + " == " + elem._2);
    ...
    qapRDD
        ...
        .foreach(
            elem -> {
              System.out.println(
                  "C(" + elem._1 + "): " + qap.Ct(elem._1.intValue()) + " == " + elem._2);
    ...
    qapRDD
        ...
        .foreach(
            elem -> {
              System.out.println(
                  "H(" + elem._1 + "): " + qap.Ht(elem._1.intValue()) + " == " + elem._2);
  ...
  public void VerifyQAPWitnessTest() {
    ...
    final QAPWitness<Fp> qapWitness =
        R1CStoQAP.R1CStoQAPWitness(r1cs, primary, auxiliary, fieldFactory, config);
    final QAPWitnessRDD<Fp> qapWitnessRDD =
        R1CStoQAPRDD.R1CStoQAPWitness(r1csRDD, primaryTwo, fullAssignmentRDD, fieldFactory, config);
    ...
    qapWitnessRDD
        ...
        .foreach(
            term -> {
              System.out.println(
                  qapWitness.coefficientsABC().get(term._1.intValue()) + " == " + term._2);
    ...
    qapWitnessRDD
        ...
        .foreach(
            term -> {
              System.out.println(
                  qapWitness.coefficientsH().get(term._1.intValue()) + " == " + term._2);
