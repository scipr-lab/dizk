...
public class Fp3 extends AbstractFieldElement<Fp3> {
  ...
  public Fp3(final Fp c0, final Fp c1, final Fp c2, final AbstractFp3Parameters Fp3Parameters) {
    this.c0 = c0;
    this.c1 = c1;
    this.c2 = c2;
  ...
  public Fp3(
      final long c0, final long c1, final long c2, final AbstractFp3Parameters Fp3Parameters) {
  ...
  public Fp3 inverse() {
    ...
    final Fp t6 =
        c0.mul(s0).add(Fp3Parameters.nonresidue().mul(c2.mul(s1).add(c1.mul(s2)))).inverse();
