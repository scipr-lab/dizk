...
public class Fp12_2Over3Over2 extends AbstractFieldElement<Fp12_2Over3Over2> {
  ...
  public Fp12_2Over3Over2 random(final Long seed, final byte[] secureSeed) {
    return new Fp12_2Over3Over2(
        c0.random(seed, secureSeed), c1.random(seed, secureSeed), Fp12Parameters);
  }
  ...
  public Fp12_2Over3Over2 square() {
    ...
    return new Fp12_2Over3Over2(
        factor.sub(c0c1).sub(mulByNonResidue(c0c1)), c0c1.add(c0c1), Fp12Parameters);
  }
  ...
  public Fp12_2Over3Over2 cyclotomicSquared() {
    ...
    t0 =
        (z0.add(z1))
            .mul(z0.add(Fp6Parameters.nonresidue().mul(z1)))
            .sub(tmp)
    ...
    t2 =
        (z2.add(z3))
            .mul(z2.add(Fp6Parameters.nonresidue().mul(z3)))
            .sub(tmp)
            .sub(Fp6Parameters.nonresidue().mul(tmp));
    t3 = tmp.add(tmp);
    ...
    t4 =
        (z4.add(z5))
            .mul(z4.add(Fp6Parameters.nonresidue().mul(z5)))
            .sub(tmp)
            .sub(Fp6Parameters.nonresidue().mul(tmp));
    t5 = tmp.add(tmp);
