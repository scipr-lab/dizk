...
public class BN254bFq2Parameters extends AbstractBNFq2Parameters implements Serializable {
  ...
  public BN254bFq2Parameters() {
    ...
    this.euler =
        new BigInteger(
            "159414945644644118800073292129041626604626750566804270203022964393707780359252029928990713085903083893311782286933981288553742977296016413844614638731264");
    this.s = 51;
    this.t =
        new BigInteger(
            "141588914499241375111247702393272641967160608237822812152571362881399413033324945424765240430089971018389667178402274750718119890976268861");
    this.tMinus1Over2 =
        new BigInteger(
            "70794457249620687555623851196636320983580304118911406076285681440699706516662472712382620215044985509194833589201137375359059945488134430");
    this.nonresidue =
        new BN254bFq(
                "17855808334804902850260923831770255773779740579862519338010824535856509878268")
            .element();
    ...
    this.nqrTot =
        new Fp2(
            ...
            new Fp(
                "4528477034828452419408251792321847194159838177818062251130215191457192224016",
                FqParameters),
            this);
